...
<?php 
    ...
    //working on checkout forms for placing an order 
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO orders (name, email, Town, Country, Zipcode, Phone_number, Address, total_price, user_id ) VALUES 
        (:name, :email, :Town, :Country, :Zipcode, :Phone_number, :Address, :total_price , :user_id )";
        ...
        $arr = $arr = [
            ...
            ":Address" => $Address,
            ":total_price" => $total_price, // no space
            ":user_id" => $user_id,
        ];
