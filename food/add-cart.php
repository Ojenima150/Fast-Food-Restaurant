...
<?php 
    ...
    if(isset($_GET['id'])) {
        ...
        //here we are validate the cart in if statement to able use to sellect the amonut of number we want 
         $count = 0; 
       ...
       if(isset($_POST['submit'])) {
          ...
          if (!isset($_SESSION['user_id'])) {
             ...
             // Prevent form from submitting if user is not logged in
...
?>
            ...
            <div class="container-xxl py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown"><?php echo $one->name; ?>                        
                    </h1>
                    ...
                    <div class="col-md-6">
                        <div class="row g-3">
                            <div class="col-12 text-start">
                                ...
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="/restoran/img/<?php echo $one->image; ?>">
                            </div>
