                                      ...
                                      <!-- Breakfast -->
                                        <div id="tab-1" class="tab-pane fade show active">
                                            <div class="row g-4 justify-content-center">
                                             <?php if ($meals_1 && is_array($meals_1)): ?>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                                ...
                                                                <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo $meal_1->id; ?>" class="btn btn-primary py-2 mt-2">View</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                        ...
                                        <div id="tab-2" class="tab-pane fade">
                                            <div class="row g-4 justify-content-center">
                                            <?php if ($meals_2 && is_array($meals_2)): ?>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                                ...
                                                                <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo $meal_2->id; ?>" class="btn btn-primary py-2 mt-2">View</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                        ...
                                        <div id="tab-3" class="tab-pane fade">
                                            <div class="row g-4 justify-content-center">
                                              <?php if ($meals_3 && is_array($meals_3)): ?>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                                ...
                                                                <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo $meal_3->id; ?>" class="btn btn-primary py-2 mt-2">View</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="POST" action="bookingtable.php">
                            <div class="row g-3">
                                <div class="col-md-6">
